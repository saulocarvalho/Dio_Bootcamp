-- inserção de dados no bd company_constraints

use company_constraints;
show tables;

insert into employee value ('John', 'B', 'Smith', 123456789, '1965-01-09', '731-Fondren-Houston-TX', 'M', 30000, 333445555, 5);
...
-- Pessoas de um departamento específico
